...
echo " Product Price : $$variation_product_price ";
	
}else{

echo "

Product Price : <del> $$variation_product_price </del><br>

Product Sale Price : $$variation_product_psp_price
...
echo " Bundle Price : $$variation_product_price ";
	
}else{

echo "

Bundle Price : <del> $$variation_product_price </del><br>

Bundle Sale Price : $$variation_product_psp_price
...
<h3 align="center"> This Product Has No Reivew, Become First To Write A Reivew. </h3>
...
By <?php echo $review_customer_name; ?> <span>(Verified owner)</span> 
...
<h3 align="center"> There Is Currently No Positive Review Of This Product. </h3>
