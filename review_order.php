...
<?php if( $enable_paypal == "no" and $enable_stripe == "no" ){ echo "checked"; } ?>> 
...
<?php if( $enable_paypal == "no" ){ echo "checked"; } ?> >  
...
<input type="hidden" name="return" value="http://localhost/new_updated_ecom/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total_cart_price; ?>">

<?php }else{ ?>

<input type="hidden" name="return" value="http://localhost/new_updated_ecom/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total; ?>">

<?php } ?>

<input type="hidden" name="cancel_return" value="http://localhost/new_updated_ecom/checkout.php">
...
data:{total: total, shipping_types: shipping_types, shipping_cost: total_shipping_cost, payment_method: payment_method, total_cart_price: total_cart_price}

})
.done(function(data){

$(".total-shipping-price").html("$" + total_cart_price + ".00");
